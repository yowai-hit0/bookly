 ...
 *
 * The frontend holds its own copy of this file (plan.md, Stack decisions: no
 * shared package); both are asserted against `docs/fixtures/quotes.json`, so a
 * divergence fails a test in both projects. This copy is the authority: the
 * browser's prices the live total a visitor watches, this one prices the
 * basket again from the catalogue, and Task 13 freezes its booking fee onto the
 * booking at write time.
 *
