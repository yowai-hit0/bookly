...
40% or can be dynamic. It can change overtime. 
...
it is fixed but can have adds on.
...
As long as a day is available. or maybe 2 hours before when Its working hours. 
...
Yes I should get email notifying me the new bookings and update the calender automatically. we have a calender in the admin. 

- Do you want to block specific time slots within a day (e.g. mornings only) or just full days?

specific time or full days. both can work.
...
Does it matter? When I can add new servies? It should be dynamic but we can start with photoshoots. personal, corporate and so on. 

- Do prices need to change seasonally or be different for different types of clients? 
Prices can change. so in the cms the services should be dynamic.
...
yes. feel free to suggest more. but anything an order can need really. 

## Business Details
- What's the business/brand name you'd like on the site? Bookly as mentioned before in the course. 
...
suggest me something. what solution can be best for me. 
...
suggest me somethings, am not too technical. 
